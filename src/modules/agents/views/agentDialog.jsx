...
const INPUT_STYLES = {
    base: "w-full bg-transparent text-gray-100 placeholder-gray-500 outline-none text-sm py-3 px-3 border border-transparent rounded-md focus:border-[#6366F1]/30 focus:ring-0",
    textarea: "w-full resize-y bg-transparent text-gray-100 placeholder-gray-500 outline-none text-sm py-3 px-3 border border-transparent rounded-md focus:border-[#6366F1]/30 focus:ring-0",
};

const VALIDATION = {
    minNameLength: 1,
    minInstructionsLength: 3,
};
...
const DialogHeader = ({ isEdit, onClose }) => (
...
const FormInputs = ({ name, setName, instructions, setInstructions, inputRef }) => (
    <>
        {/* Avatar + Name */}
        ...
        <div className="fixed inset-0 z-50">
            ...
            <div className="relative mx-auto w-full max-w-lg md:max-w-2xl px-4 py-12">
                ...
                >
                    ...
                    <DialogHeader isEdit={isEdit} onClose={close} />
